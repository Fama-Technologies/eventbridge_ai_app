...
class ActiveBookingDetailsScreen extends ConsumerStatefulWidget {
  final String bookingId;
  const ActiveBookingDetailsScreen({super.key, required this.bookingId});

  @override
  ConsumerState<ActiveBookingDetailsScreen> createState() =>
      _ActiveBookingDetailsScreenState();
}
...
class _ActiveBookingDetailsScreenState
  ...
  Widget build(BuildContext context) {
    ...
    final booking = leads.where((l) => l.id == widget.bookingId).firstOrNull;
    ...
    if (booking == null) {
      return Scaffold(
        ...
        body: const Center(
          child: Text('The requested booking could not be found.'),
        ),
      );
    }
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    if (booking.venueAddress.isNotEmpty)
                      Text(
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Final payment due 2 days before event.',
                    style: GoogleFonts.outfit(
                      color: Colors.white,
                      fontSize: 12,
                      fontWeight: FontWeight.w600,
